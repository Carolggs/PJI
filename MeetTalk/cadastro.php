...
<htmr lang="en">
  ...
  <body>
    ...
    <div class="columns has-background-white mt-6">
      <div class="column has-background-white"></div>
      <div class="column mt-4">
        <div class="container mt-3">
          ...
          <form class="box pt-5 pl-5 mt-6 has-background-white" method="POST" action="usuario.php">
              ...
              <div class="field">
                ...
                <div class="control">
                  <input class="input is-info mt-1 mb-4 is-hovered" type="email" placeholder="E-mail">
                </div>
              </div>
              ...
              <div class="field">
                ...
                <div class="control ">
                  <input class="input is-info mt-1 mb-4 is-hovered" type="password" placeholder="Senha">
                </div>
              </div>


              <div class="field">
                <label class="is-size-6">Data de Nascimento</label>
                <div class="control ">
                  <input class="input is-info mt-1 mb-4 is-hovered" type="date" placeholder="Data de Nascimento">
                </div>
              </div>
              ...
              <br>
              <br>
              <button class="button mb-4  mt-1 is-info is-responsive" type="submit">Entrar</button>


              <p>Já tem uma conta? <b><a href="login.html" class="has-text-info">Entre aqui
                  </a></b></p>
